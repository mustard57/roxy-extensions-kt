class Help
  def self.usage
    <<-DOC.strip_heredoc
      ...
      Extensions
        create_scheduled_task               Creates required scheduled tasks
        delete_scheduled_task               Deletes scheduled tasks
        ...
        change_password_multiple_environments <USER> <ENV1> <ENV2> <ENV3> ... Change user password in all named environments
		add_admin_user <USER>				Add a user with admin privileges
		add_application_user <USER>			Add a user with application privileges
